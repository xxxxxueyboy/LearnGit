...
/** check * */
public List<Users> checkIdcard(String name) {return this.usersDAO.queryByIdcard(name);}
/** check * */
public List<Users> checkContact(String name) {return this.usersDAO.queryByContact(name);}
/** check * */
public List<Users> checkImage(String name) {return this.usersDAO.queryByImage(name);}
/** check * */
...
/** check * */
public List<Users> checkByLikeIdcard(String name) {return this.usersDAO.queryLikeByIdcard(name);}
/** check * */
public List<Users> checkByLikeContact(String name) {return this.usersDAO.queryLikeByContact(name);}
/** check * */
public List<Users> checkByLikeImage(String name) {return this.usersDAO.queryLikeByImage(name);}
/** check * */
