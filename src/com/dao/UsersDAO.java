...
public class UsersDAO extends HibernateDaoSupport {
	...
	// 通过HQL语句模糊查询数据)
	@SuppressWarnings("unchecked")
	public List<Users> queryByIdcard(String name) {
		List<Users> list = new ArrayList<Users>();
		String hql = "From Users where idcard = ?";
		Session session = this.getSessionFactory().openSession();
		Query query = session.createQuery(hql);
		query.setString(0, name);
		list = query.list();
	...
	// 通过HQL语句模糊查询数据)
	@SuppressWarnings("unchecked")
	public List<Users> queryByImage(String name) {
		List<Users> list = new ArrayList<Users>();
		String hql = "From Users where image = ?";
		Session session = this.getSessionFactory().openSession();
		Query query = session.createQuery(hql);
		query.setString(0, name);
		list = query.list();
	...
	// 按条件查询数据(模糊查询)
	@SuppressWarnings("unchecked")
	public List<Users> queryLikeByIdcard(String name) {
		List<Users> list = new ArrayList<Users>();
		String hql = "From Users where idcard like ?";
		Session session = this.getSessionFactory().openSession();
		Query query = session.createQuery(hql);
		query.setString(0, "%" + name + "%");
		list = query.list();
	...
	// 按条件查询数据(模糊查询)
	@SuppressWarnings("unchecked")
	public List<Users> queryLikeByImage(String name) {
		List<Users> list = new ArrayList<Users>();
		String hql = "From Users where image like ?";
		Session session = this.getSessionFactory().openSession();
		Query query = session.createQuery(hql);
		query.setString(0, "%" + name + "%");
		list = query.list();
