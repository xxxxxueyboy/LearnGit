		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">义工报名信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">用户</td>
						<td align="center" bgcolor="#ebf0f7">义工活动</td>
						<td align="center" bgcolor="#ebf0f7">报名日期</td>
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center"><s:property value="activities.title" /></td>
							<td align="center"><s:property value="addtime" /></td>
							<td align="center"><s:property value="status" /></td>
							<td align="center">
							<s:if test="status=='未审核'">
							<s:a href="asign/accept.action?id=%{asignid}" >同意</s:a>
							</s:if>
							<s:if test="status=='未审核'">
							<s:a href="asign/refuse.action?id=%{asignid}" >拒绝</s:a>
							</s:if>
							<s:a
									href="asign/deleteAsign.action?asign.asignid=%{asignid}"
