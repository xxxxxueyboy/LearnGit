		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">动物信息列表</td>
					</tr>
					<tr align="center">
						<td align="center" bgcolor="#ebf0f7">动物号</td>
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center"><s:property value="petname" /></td>
							...
							<td align="center"><s:if test="status != '已领养'">
									<s:a href="pet/getPetById.action?id=%{petid}">编辑</s:a>&nbsp;&nbsp;<s:a
										href="pet/deletePet.action?pet.petid=%{petid}"
