			...
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center"><s:a
									href="activities/getActivitiesById.action?id=%{activitiesid}">编辑</s:a>|<s:a
									href="activities/deleteActivities.action?activities.activitiesid=%{activitiesid}"
