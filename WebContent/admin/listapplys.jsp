			...
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center">
							<s:if test="status =='未批准'">
								<s:a href="applys/refuse.action?id=%{applysid}">拒绝</s:a>|
							</s:if>
							<s:if test="status =='未批准'">
								<s:a href="applys/accept.action?id=%{applysid}">同意</s:a>|
							</s:if>
							<s:a
									href="applys/deleteApplys.action?applys.applysid=%{applysid}"
