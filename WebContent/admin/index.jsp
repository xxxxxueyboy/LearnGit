...
<body>
	<form action="<%=basePath%>admin/login.action" name="myform"
					...
					<td vAlign=top bgColor=#ffffff>
						<table cellSpacing=0 cellPadding=0 width="100%" border=0>
							<tbody>
														...
														<table cellSpacing=1 cellPadding=2 width="100%"
															...
															<tbody>
																<tr>
																	...
																	<td height=30><input id="username"
																		name="admin.username"></td>
																</tr>
																<tr>
																...
																<tr align="center">
																	<td colSpan=2 height=40><input class="btn"
																		type=submit value="提 交" name="Submit"> <input
																		class="btn" type="reset" value="取 消" name="reset">
																	</td>
																</tr>
															</tbody>
														</table>
								...
								<tr>
									<td align=middle bgColor=#9CBFE5 height=25>2020 
										流浪动物救助信息分享平台 All Rights Reserved </td>
								</tr>
							</tbody>
						</table>
					</td>
