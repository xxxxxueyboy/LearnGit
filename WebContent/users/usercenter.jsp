							...
							<table width="100%" border="0" cellpadding="5" cellspacing="1"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF">
										...
										name="users.username" style="width: 160px" id="username"
										value="${sessionScope.users.username }" /> <input
										type="hidden" name="users.password" style="width: 160px"
										id="password" value="${sessionScope.users.password }" /> <input
										type="hidden" name="users.usersid" style="width: 160px"
										id="usersid" value="${sessionScope.users.usersid }" />
									</td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">姓名：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										name="users.realname" type="text" size="25" class="inputBg"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										name="users.birthday" type="text" size="25" class="inputBg"
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										name="users.idcard" type="text" size="25"
										value="${sessionScope.users.contact }" class="inputBg"
										id="idcard" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">联系方式：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										name="users.contact" type="text" size="25" class="inputBg"
										id="contact" value="${sessionScope.users.contact }" /></td>
								</tr>
								<tr>
									<td width="28%" align="right" bgcolor="#FFFFFF">头像：</td>
									<td width="76%" align="left" bgcolor="#FFFFFF"><input
										name="users.image" type="text" size="25" class="inputBg"
										id="image" value="${sessionScope.users.image }"
