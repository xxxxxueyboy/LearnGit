...
<body style="min-width: 1200px;">
	...
	<div class="block clearfix Main">
			...
			<div id="mallNews" class="  box_1">
				...
				<div class="NewsList tc  " style="border-top: none">
					<s:iterator value="map.articleList">
						<li><a href="index/read.action?id=${articleid }">${title }</a>
						</li>
					</s:iterator>
				</div>
			</div>
		...
		<div class="goodsBox_1">
			...
			<div class="xm-box">
				<h4 class="title">
					<span>&nbsp;&nbsp;&nbsp;推荐动物</span> <a class="more" href="index/all.action">更多</a>
				</h4>
				<div id="show_new_area" class="clearfix">
					<s:iterator value="map.newsList">
						<div class="goodsItem">
							<a href="index/detail.action?id=${petid }"><img
								src="${image }" alt="${petname }" class="goodsimg" /> </a> <br />
							<p class="f1">
								<a href="index/detail.action?id=${petid }" title="${petname }">${petname }</a>
							</p>
						</div>
					</s:iterator>
				</div>
			...
			<s:iterator value="map.frontList">
				<div class="xm-box">
					<h4 class="title">
						<span>${catename }</span> <a class="more"
							href="index/cate.action?id=${cateid }">更多</a>
					</h4>
