						...
						<s:iterator value="map.bbsList">
							<tr align="center" class="tr3 t_one">
								<td style="text-align: left; padding-left: 8px" id="">
									<h3>
										<a href="index/readbbs.action?id=${bbsid }" target="_blank" title="标题：${title }"><font class="p14">
												${title }</font> </a>
									</h3>
								</td>
							...
							<table cellpadding="0" cellspacing="0" align="center">
								...
								<tbody>
									<tr class="tr3 f_one">
										...
										<th>
											<input class="input" name="bbs.title" id='title' size="60" value="" tabindex="1"
															style="font: 14px Tahoma; padding-left: 2px" />
										</th>
									</tr>
								</tbody>
								<tbody>
									<tr class="tr3 f_two">
										...
										<th colspan="2">
											<div class="wysiwyg" style="padding: 0x; border: 1px solid #DDDDDD; margin-bottom: 5px;">
												<textarea cols="80" id="contents" name="bbs.contents" rows="10">在此添加内容</textarea>
