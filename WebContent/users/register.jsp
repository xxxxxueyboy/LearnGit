								...
								<table width="60%" border="0" cellpadding="5" cellspacing="1"
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input
											type="text" name="users.username" size="25" class="inputBg"
											id="username" /></td>
									</tr>
									<tr>
										<td width="28%" align="right" bgcolor="#FFFFFF">密码：</td>
										<td width="76%" align="left" bgcolor="#FFFFFF"><input
											name="users.password" type="password" size="25"
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><select
											name="users.sex" id="sex" class="inputBg">
									...
									<tr>
										...
										<td width="76%" align="left" bgcolor="#FFFFFF"><input
											name="users.idcard" type="text" size="25" class="inputBg"
											id="idcard" /></td>
									</tr>
									<tr>
